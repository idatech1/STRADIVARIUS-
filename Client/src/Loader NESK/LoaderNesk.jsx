...
import "./LoaderNesk.css";

const LoaderNesk = () => {
  const svgRef = useRef(null);

  useEffect(() => {
    // Animation du SVG (remplace l'ancienne animation CSS)
    gsap.fromTo(
      svgRef.current,
    ...
    // Animation du fade-out du loader
    gsap.fromTo(
      ".loading-page2",
      { opacity: 1 },
      {
    ...
    // Animation du texte "NESK INVESTMENT"
    gsap.fromTo(
      ".logo-name3",
      { y: 50, opacity: 0 },
  ...
  return (
    <div className="loading-page2">
      ...
      <div className="name-container2">
        <div className="logo-name3">NESK INVESTMENT</div>
      </div>
    </div>
  );
};

export default LoaderNesk;